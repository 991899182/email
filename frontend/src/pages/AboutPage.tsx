  ...
  return (
    <Container>
      <div className="prose max-w-none mx-auto">
        ...
        <ul>
          <li><strong>{t('about.opensource.github.title')}</strong>：<a href="https://0tg.shop" className="text-blue-600 hover:underline">https://0tg.shop</a></li>
        ...
        <ul>
          ...
          <li><strong>{t('about.contact.email.title')}</strong>：huangyi@rvxy.com</li>
        </ul>
